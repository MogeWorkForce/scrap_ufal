...
logger_analysis = logging.getLogger("HBEM.data_analysis")
...
urls = ["http://portaltransparencia.gov.br/despesasdiarias/empenho?documento=153031152502013NE803021",
"http://portaltransparencia.gov.br/despesasdiarias/empenho?documento=153037152222015NE800190",
"http://portaltransparencia.gov.br/despesasdiarias/empenho?documento=154040152572013NE805586",
"http://portaltransparencia.gov.br/despesasdiarias/empenho?documento=153079152322013NE806443",
"http://portaltransparencia.gov.br/despesasdiarias/empenho?documento=154040152572013NE806093",
"http://portaltransparencia.gov.br/despesasdiarias/empenho?documento=154039152562015NE800869",
"http://portaltransparencia.gov.br/despesasdiarias/empenho?documento=153037152222012NE800485",
"http://portaltransparencia.gov.br/despesasdiarias/empenho?documento=153037152222012NE801278",
"http://portaltransparencia.gov.br/despesasdiarias/empenho?documento=153037152222013NE802159",
"http://portaltransparencia.gov.br/despesasdiarias/empenho?documento=153037152222013NE802155"]
...
def analysis_bidding_mode():
    ...
    for role in docs_dao.roles.find():
        ...
        for doc in docs_dao.documents.find(json.loads(role["query"])):
            ...
            mod_licitacao = doc["dados_detalhados_do_empenho"]["elemento_de_despesa"]
